...
export const metadata: Metadata = {
    ...
    description:
        "Backend and cloud software engineer. Java/Spring Boot, AWS (VPC, RDS, Cognito), React/Next.js, and Docker.",
    metadataBase: new URL("https://cameron-basham.com"),
    openGraph: {
        title: "Cameron Basham - Portfolio",
        description:
            "Backend and cloud software engineer. Java/Spring Boot, AWS, and React/Next.js.",
        url: "/",
        ...
        <html lang="en" className="h-full">
            ...
            >
                ...
                <footer className="border-t border-white/10 py-6 text-center text-xs text-gray-400">
                    (c) {new Date().getFullYear()} Cameron Basham
                </footer>
            </body>
        </html>
    );
